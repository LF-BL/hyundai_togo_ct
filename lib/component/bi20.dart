...
class bi20 extends StatefulWidget {
  @override
  _bi20State createState() => _bi20State();
}

class _bi20State extends State<bi20> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 15; i++) {
      imageList.add(AssetImage('assets/images/bi20/$i.jpg'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/bi20/$i.jpg'), context);
    }
    setState(() {
      imagePrecached = true;
    });
