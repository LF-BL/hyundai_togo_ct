...
class Accent extends StatefulWidget {
  @override
  _AccentState createState() => _AccentState();
}

class _AccentState extends State<Accent> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 36; i++) {
      imageList.add(AssetImage('assets/images/accent/$i.jpg'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/accent/$i.jpg'), context);
    }
    setState(() {
      imagePrecached = true;
    });
