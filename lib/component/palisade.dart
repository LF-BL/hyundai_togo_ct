...
class Palisade extends StatefulWidget {
  @override
  _PalisadeState createState() => _PalisadeState();
}

class _PalisadeState extends State<Palisade> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 36; i++) {
      imageList.add(AssetImage('assets/images/palisade/$i.webp'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/palisade/$i.webp'), context);
    }
    setState(() {
      imagePrecached = true;
    });
