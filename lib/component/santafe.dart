...
class SantaFe extends StatefulWidget {
  @override
  _SantaFeState createState() => _SantaFeState();
}

class _SantaFeState extends State<SantaFe> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 33; i++) {
      imageList.add(AssetImage('assets/images/santafe/$i.png'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/santafe/$i.png'), context);
    }
    setState(() {
      imagePrecached = true;
    });
