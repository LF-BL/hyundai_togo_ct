...
class Sonata extends StatefulWidget {
  @override
  _SonataState createState() => _SonataState();
}

class _SonataState extends State<Sonata> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 36; i++) {
      imageList.add(AssetImage('assets/images/sonata/$i.png'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/sonata/$i.png'), context);
    }
    setState(() {
      imagePrecached = true;
    });
