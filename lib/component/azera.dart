...
class Azera extends StatefulWidget {
  @override
  _AzeraState createState() => _AzeraState();
}

class _AzeraState extends State<Azera> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 36; i++) {
      imageList.add(AssetImage('assets/images/azera/$i.png'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/images/azera/$i.png'), context);
    }
    setState(() {
      imagePrecached = true;
    });
